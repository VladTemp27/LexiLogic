...
/**
* org/amalgam/Service/Game/GameServicePackage/MatrixHelper.java .
...
{
  private static String  _id = "IDL:org/amalgam/Service/Game/GameService/Matrix:1.0";
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      ...
      __typeCode = org.omg.CORBA.ORB.init ().create_array_tc (6, __typeCode );
      __typeCode = org.omg.CORBA.ORB.init ().create_alias_tc (org.amalgam.Service.Game.GameServicePackage.MatrixHelper.id (), "Matrix", __typeCode);
    }
    return __typeCode;
  }
