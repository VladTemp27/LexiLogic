...
/**
* org/amalgam/lexilogicserver/DAL/DALPlayer/PlayerDALPOA.java .
...
public abstract class PlayerDALPOA extends org.omg.PortableServer.Servant
 implements org.amalgam.lexilogicserver.DAL.DALPlayer.PlayerDALOperations, org.omg.CORBA.portable.InvokeHandler
{
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    {
       case 0:  // org/amalgam/lexilogicserver/DAL/DALPlayer/PlayerDAL/insertNewPlayer
       {
         try {
       ...
       case 1:  // org/amalgam/lexilogicserver/DAL/DALPlayer/PlayerDAL/getPlayerByID
       {
         try {
           int playerID = in.read_long ();
           org.amalgam.lexilogicserver.DAL.DALPlayer.PlayerDALPackage.Player $result = null;
           $result = this.getPlayerByID (playerID);
           out = $rh.createReply();
           org.amalgam.lexilogicserver.DAL.DALPlayer.PlayerDALPackage.PlayerHelper.write (out, $result);
       ...
       case 2:  // org/amalgam/lexilogicserver/DAL/DALPlayer/PlayerDAL/updatePassword
       {
         try {
           int playerID = in.read_long ();
           ...
           out = $rh.createReply();
         } catch (org.amalgam.lexilogicserver.DAL.SQLExceptions.SQLUpdateError $ex) {
           out = $rh.createExceptionReply ();
           org.amalgam.lexilogicserver.DAL.SQLExceptions.SQLUpdateErrorHelper.write (out, $ex);
         }
         break;
       }

       case 3:  // org/amalgam/lexilogicserver/DAL/DALPlayer/PlayerDAL/updateUsername
       {
         try {
           int playerID = in.read_long ();
       ...
       case 4:  // org/amalgam/lexilogicserver/DAL/DALPlayer/PlayerDAL/deletePlayer
       {
         try {
           int playerID = in.read_long ();
           this.deletePlayer (playerID);
           out = $rh.createReply();
         } catch (org.amalgam.lexilogicserver.DAL.SQLExceptions.SQLDeleteError $ex) {
           out = $rh.createExceptionReply ();
           org.amalgam.lexilogicserver.DAL.SQLExceptions.SQLDeleteErrorHelper.write (out, $ex);
         }
         break;
       }
