 ...
 implements PlayerServiceOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("getGameResult", new Integer (6));
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       ...
       {
         try {
           org.amalgam.Utils.UIControllers.PlayerCallback player_callback = org.amalgam.Service.PlayerServiceModule.PlayerServicePackage.PlayerCallbackHelper.read (in);
       ...
       {
         try {
           org.amalgam.Utils.Objects.Player newPlayer = org.amalgam.Service.PlayerServiceModule.PlayerServicePackage.PlayerHelper.read (in);
           this.createAccount (newPlayer);
           out = $rh.createReply();
       ...
       case 6:  // org/amalgam/Service/PlayerServiceModule/PlayerService/getGameResult
       {
         try {
         ...
         } catch (org.amalgam.Utils.Exceptions.GameResultUnavailableException $ex) {
           out = $rh.createExceptionReply ();
           org.amalgam.Utils.Exceptions.GameResultUnavailableExceptionHelper.write (out, $ex);
       ...
       case 7:  // org/amalgam/Service/PlayerServiceModule/PlayerService/getGameHistory
       {
         try {
           String playerName = in.read_string ();
           org.amalgam.Utils.Objects.Lobby $result[] = null;
           $result = this.getGameHistory (playerName);
           out = $rh.createReply();
           org.amalgam.Service.PlayerServiceModule.PlayerServicePackage.historyHelper.write (out, $result);
