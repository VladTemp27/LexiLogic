 ...
 implements GameServiceOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("readyHandshake", new Integer (1));
    _methods.put ("fetchWordBox", new Integer (2));
    _methods.put ("getLeaderboards", new Integer (3));
    _methods.put ("verifyWord", new Integer (4));
    _methods.put ("validateTotalPoints", new Integer (5));
    _methods.put ("fetchWinner", new Integer (6));
    _methods.put ("playerReady", new Integer (7));
  }
    ...
    switch (__method.intValue ())
    {
       case 0:  // org/amalgam/Service/GameServiceModule/GameService/matchMake
       {
         try {
           ...
           org.amalgam.UIControllers.MatchmakeCallback matchmake_callback = org.amalgam.Service.GameServiceModule.GameServicePackage.MatchmakeCallbackHelper.read (in);
           String $result = null;
           $result = this.matchMake (player_callback, matchmake_callback);
           out = $rh.createReply();
       ...
       case 1:  // org/amalgam/Service/GameServiceModule/GameService/readyHandshake
       {
         String username = in.read_string ();
         int callback = in.read_long ();
         this.readyHandshake (username, callback);
         out = $rh.createReply();
         break;
       }

       case 2:  // org/amalgam/Service/GameServiceModule/GameService/fetchWordBox
       {
         try {
       ...
       case 3:  // org/amalgam/Service/GameServiceModule/GameService/getLeaderboards
       {
         try {
           String $result = null;
       ...
       case 4:  // org/amalgam/Service/GameServiceModule/GameService/verifyWord
       {
         try {
       ...
       case 5:  // org/amalgam/Service/GameServiceModule/GameService/validateTotalPoints
       {
         try {
           int $result = (int)0;
       ...
       case 6:  // org/amalgam/Service/GameServiceModule/GameService/fetchWinner
       {
         try {
       ...
       case 7:  // org/amalgam/Service/GameServiceModule/GameService/playerReady
       {
         String username = in.read_string ();
         int gameRoomID = in.read_long ();
         String $result = null;
