...
public class _GameServiceStub extends org.omg.CORBA.portable.ObjectImpl implements GameService
{
  ...
  public String matchMake (org.amalgam.UIControllers.PlayerCallback player_callback, org.amalgam.UIControllers.MatchmakeCallback matchmake_callback) throws org.amalgam.Utils.Exceptions.MatchCreationFailedException
  {
            ...
            try {
                ...
                org.amalgam.Service.GameServiceModule.GameServicePackage.MatchmakeCallbackHelper.write ($out, matchmake_callback);
                $in = _invoke ($out);
                ...
                return matchMake (player_callback, matchmake_callback        );
            } finally {
                _releaseReply ($in);
            }
  } // matchMake
