...
public class _LeaderboardStub extends org.omg.CORBA.portable.ObjectImpl implements Leaderboard
{
  ...
  public int getLeaderboardID () throws org.amalgam.Utils.Exceptions.LeaderboardIDRetrievalException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                ...
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
                if (_id.equals ("IDL:org/amalgam/Utils/Exceptions/LeaderboardIDRetrievalException:1.0"))
                    throw org.amalgam.Utils.Exceptions.LeaderboardIDRetrievalExceptionHelper.read ($in);
                else
                    throw new org.omg.CORBA.MARSHAL (_id);
            } catch (org.omg.CORBA.portable.RemarshalException $rm) {
