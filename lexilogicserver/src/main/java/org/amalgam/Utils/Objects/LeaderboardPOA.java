    ...
    switch (__method.intValue ())
    {
       ...
       case 8:  // org/amalgam/Utils/Objects/Leaderboard/getLeaderboardID
       {
         try {
           ...
           out = $rh.createReply();
           out.write_long ($result);
         } catch (org.amalgam.Utils.ObjectExceptions.LeaderboardIDRetrievalException $ex) {
           out = $rh.createExceptionReply ();
           org.amalgam.Utils.ObjectExceptions.LeaderboardIDRetrievalExceptionHelper.write (out, $ex);
         }
         break;
       }
