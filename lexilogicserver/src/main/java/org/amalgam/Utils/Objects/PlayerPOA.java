    ...
    switch (__method.intValue ())
    {
       ...
       case 8:  // org/amalgam/Utils/Objects/Player/addPlayer
       {
         try {
           ...
           out = $rh.createReply();
         } catch (org.amalgam.Utils.Exceptions.DuplicatePlayerIDException $ex) {
           out = $rh.createExceptionReply ();
           org.amalgam.Utils.Exceptions.DuplicatePlayerIDExceptionHelper.write (out, $ex);
         } catch (org.amalgam.Utils.Exceptions.InvalidPlayerDataException $ex) {
           out = $rh.createExceptionReply ();
           org.amalgam.Utils.Exceptions.InvalidPlayerDataExceptionHelper.write (out, $ex);
       ...
       case 10:  // org/amalgam/Utils/Objects/Player/updatePassword
       {
         try {
           ...
           out = $rh.createReply();
         } catch (org.amalgam.Utils.Exceptions.InvalidPasswordException $ex) {
           out = $rh.createExceptionReply ();
           org.amalgam.Utils.Exceptions.InvalidPasswordExceptionHelper.write (out, $ex);
         } catch (org.amalgam.Utils.Exceptions.SQLError $ex) {
           out = $rh.createExceptionReply ();
           org.amalgam.Utils.Exceptions.SQLErrorHelper.write (out, $ex);
         }
       ...
       case 11:  // org/amalgam/Utils/Objects/Player/updateLastLogin
       {
         try {
           ...
           out = $rh.createReply();
         } catch (org.amalgam.Utils.Exceptions.UpdateLastLoginException $ex) {
           out = $rh.createExceptionReply ();
           org.amalgam.Utils.Exceptions.UpdateLastLoginExceptionHelper.write (out, $ex);
         } catch (org.amalgam.Utils.Exceptions.SQLError $ex) {
           out = $rh.createExceptionReply ();
           org.amalgam.Utils.Exceptions.SQLErrorHelper.write (out, $ex);
         }
