...
/**
* org/amalgam/DAL/DALGameDetail/GameDetailsDALPOA.java .
...
public abstract class GameDetailsDALPOA extends org.omg.PortableServer.Servant
 implements GameDetailsDALOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    _methods.put ("insertNewGameDetail", new Integer (0));
    _methods.put ("getGameDetailByID", new Integer (1));
  }
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    {
       case 0:  // org/amalgam/DAL/DALGameDetail/GameDetailsDAL/insertNewGameDetail
       {
         try {
       ...
       case 1:  // org/amalgam/DAL/DALGameDetail/GameDetailsDAL/getGameDetailByID
       {
         try {
           int lobbyID = in.read_long ();
           org.amalgam.Utils.Objects.GameDetail $result = null;
           $result = this.getGameDetailByID (lobbyID);
           out = $rh.createReply();
           org.amalgam.Utils.Objects.GameDetailHelper.write (out, $result);
