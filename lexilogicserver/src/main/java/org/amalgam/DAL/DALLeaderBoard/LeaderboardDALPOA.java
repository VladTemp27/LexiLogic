...
public abstract class LeaderboardDALPOA extends org.omg.PortableServer.Servant
 implements org.amalgam.DAL.DALLeaderBoard.LeaderboardDALOperations, org.omg.CORBA.portable.InvokeHandler
{
    ...
    switch (__method.intValue ())
    {
       ...
       case 1:  // org/amalgam/DAL/DALLeaderBoard/LeaderboardDAL/getLeaderboardByID
       {
         try {
           ...
           org.amalgam.DAL.DALLeaderBoard.LeaderboardDALPackage.Leaderboard $result = null;
           $result = this.getLeaderboardByID (leaderboardID);
           out = $rh.createReply();
           org.amalgam.DAL.DALLeaderBoard.LeaderboardDALPackage.LeaderboardHelper.write (out, $result);
