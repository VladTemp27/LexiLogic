...
public abstract class PlayerDALPOA extends org.omg.PortableServer.Servant
 implements PlayerDALOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    _methods.put ("insertNewPlayer", new Integer (0));
    _methods.put ("getPlayerByID", new Integer (1));
    _methods.put ("updatePassword", new Integer (2));
    _methods.put ("updateUsername", new Integer (3));
    _methods.put ("deletePlayer", new Integer (4));
  }
