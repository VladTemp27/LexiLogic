...
public class _LobbyDALStub extends org.omg.CORBA.portable.ObjectImpl implements org.amalgam.DAL.DALLobby.LobbyDAL
{
  ...
  public org.amalgam.DAL.DALLobby.LobbyDALPackage.Lobby getLobbyByID (int lobbyId) throws org.amalgam.DAL.SQLExceptions.SQLRetrieveError
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                ...
                $in = _invoke ($out);
                org.amalgam.DAL.DALLobby.LobbyDALPackage.Lobby $result = org.amalgam.DAL.DALLobby.LobbyDALPackage.LobbyHelper.read ($in);
                return $result;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
