...
public class _GameServiceStub extends org.omg.CORBA.portable.ObjectImpl implements GameService
{
  ...
  public org.amalgam.Utils.Objects.Leaderboard[] getLeaderboards () throws org.amalgam.Service.GameExceptions.EmptyLeaderBoard
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
  ...
  public String fetchWinner (int lobbyId) throws org.amalgam.Service.GameExceptions.LobbyDoesNotExist, org.amalgam.Service.GameExceptions.WinnerDoesNotExist
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                ...
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
                if (_id.equals ("IDL:org/amalgam/Service/GameExceptions/LobbyDoesNotExist:1.0"))
                    throw org.amalgam.Service.GameExceptions.LobbyDoesNotExistHelper.read ($in);
  ...
  public void insertLobby (org.amalgam.Utils.Objects.Lobby lobby) throws org.amalgam.Service.GameExceptions.InvalidLobbyData
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("insertLobby", true);
                org.amalgam.Service.GameServiceModule.GameServicePackage.LobbyHelper.write ($out, lobby);
                $in = _invoke ($out);
                return;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
