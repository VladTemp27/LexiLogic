...
public class _GameRoomStub extends org.omg.CORBA.portable.ObjectImpl implements GameRoom
{
  ...
  public void addPlayer (String playerName) throws org.amalgam.Utils.ObjectExceptions.PlayerAlreadyInRoom, org.amalgam.Utils.ObjectExceptions.SQLError
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                ...
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
                if (_id.equals ("IDL:org/amalgam/Utils/ObjectExceptions/PlayerAlreadyInRoom:1.0"))
                    throw org.amalgam.Utils.ObjectExceptions.PlayerAlreadyInRoomHelper.read ($in);
  ...
  public int getRoomID () throws org.amalgam.Utils.ObjectExceptions.RoomDoesNotExistException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                ...
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
                if (_id.equals ("IDL:org/amalgam/Utils/ObjectExceptions/RoomDoesNotExistException:1.0"))
                    throw org.amalgam.Utils.ObjectExceptions.RoomDoesNotExistExceptionHelper.read ($in);
                else
                    throw new org.omg.CORBA.MARSHAL (_id);
            } catch (org.omg.CORBA.portable.RemarshalException $rm) {
                return getRoomID (        );
  ...
  public String[] getPlayers () throws org.amalgam.Utils.ObjectExceptions.PlayerListRetrievalException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                ...
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
                if (_id.equals ("IDL:org/amalgam/Utils/ObjectExceptions/PlayerListRetrievalException:1.0"))
                    throw org.amalgam.Utils.ObjectExceptions.PlayerListRetrievalExceptionHelper.read ($in);
                else
                    throw new org.omg.CORBA.MARSHAL (_id);
            } catch (org.omg.CORBA.portable.RemarshalException $rm) {
                return getPlayers (        );
