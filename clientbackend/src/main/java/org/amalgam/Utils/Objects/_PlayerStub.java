...
public class _PlayerStub extends org.omg.CORBA.portable.ObjectImpl implements Player
{
  ...
  public void addPlayer (Player player) throws org.amalgam.Utils.ObjectExceptions.DuplicatePlayerIDException, org.amalgam.Utils.ObjectExceptions.InvalidPlayerDataException, org.amalgam.Utils.ObjectExceptions.SQLError
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                ...
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
                if (_id.equals ("IDL:org/amalgam/Utils/ObjectExceptions/DuplicatePlayerIDException:1.0"))
                    throw org.amalgam.Utils.ObjectExceptions.DuplicatePlayerIDExceptionHelper.read ($in);
                else if (_id.equals ("IDL:org/amalgam/Utils/ObjectExceptions/InvalidPlayerDataException:1.0"))
                    throw org.amalgam.Utils.ObjectExceptions.InvalidPlayerDataExceptionHelper.read ($in);
  ...
  public void updateName (String newName) throws org.amalgam.Utils.ObjectExceptions.InvalidNameException, org.amalgam.Utils.ObjectExceptions.SQLError
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
  ...
  public void updatePassword (String newPassword) throws org.amalgam.Utils.ObjectExceptions.InvalidPasswordException, org.amalgam.Utils.ObjectExceptions.SQLError
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                ...
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
                if (_id.equals ("IDL:org/amalgam/Utils/ObjectExceptions/InvalidPasswordException:1.0"))
                    throw org.amalgam.Utils.ObjectExceptions.InvalidPasswordExceptionHelper.read ($in);
                else if (_id.equals ("IDL:org/amalgam/Utils/ObjectExceptions/SQLError:1.0"))
                    throw org.amalgam.Utils.ObjectExceptions.SQLErrorHelper.read ($in);
                else
                    throw new org.omg.CORBA.MARSHAL (_id);
  ...
  public void updateLastLogin (String newTime) throws org.amalgam.Utils.ObjectExceptions.UpdateLastLoginException, org.amalgam.Utils.ObjectExceptions.SQLError
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                ...
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
                if (_id.equals ("IDL:org/amalgam/Utils/ObjectExceptions/UpdateLastLoginException:1.0"))
                    throw org.amalgam.Utils.ObjectExceptions.UpdateLastLoginExceptionHelper.read ($in);
                else if (_id.equals ("IDL:org/amalgam/Utils/ObjectExceptions/SQLError:1.0"))
                    throw org.amalgam.Utils.ObjectExceptions.SQLErrorHelper.read ($in);
                else
                    throw new org.omg.CORBA.MARSHAL (_id);
  ...
  public void deletePlayer (int id) throws org.amalgam.Utils.ObjectExceptions.PlayerDoesNotExistException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
