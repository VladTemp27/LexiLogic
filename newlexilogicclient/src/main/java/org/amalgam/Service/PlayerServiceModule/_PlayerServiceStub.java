...
public class _PlayerServiceStub extends org.omg.CORBA.portable.ObjectImpl implements PlayerService
{
  ...
  public void login (org.amalgam.Utils.UIControllers.PlayerCallback player_callback) throws org.amalgam.Utils.Exceptions.AlreadyLoggedInException, org.amalgam.Utils.Exceptions.InvalidCredentialsException, org.amalgam.Utils.Exceptions.UserExistenceException
  {
  ...
  public void logout () throws org.amalgam.Utils.Exceptions.NotLoggedInException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
  ...
  public void createAccount (org.amalgam.Utils.Objects.Player newPlayer) throws org.amalgam.Utils.Exceptions.AccountCreationFailedException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("createAccount", true);
                org.amalgam.Service.PlayerServiceModule.PlayerServicePackage.PlayerHelper.write ($out, newPlayer);
                $in = _invoke ($out);
                return;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
  ...
  public String getGameResult (String playerName) throws org.amalgam.Utils.Exceptions.GameResultUnavailableException, org.amalgam.Utils.Exceptions.InGameException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                ...
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
                if (_id.equals ("IDL:org/amalgam/Utils/Exceptions/GameResultUnavailableException:1.0"))
                    throw org.amalgam.Utils.Exceptions.GameResultUnavailableExceptionHelper.read ($in);
  ...
  public org.amalgam.Utils.Objects.Lobby[] getGameHistory (String playerName) throws org.amalgam.Utils.Exceptions.GameHistoryUnavailableException, org.amalgam.Utils.Exceptions.InGameException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                ...
                $out.write_string (playerName);
                $in = _invoke ($out);
                org.amalgam.Utils.Objects.Lobby $result[] = org.amalgam.Service.PlayerServiceModule.PlayerServicePackage.historyHelper.read ($in);
                return $result;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
                ...
                return getGameHistory (playerName        );
            } finally {
                _releaseReply ($in);
            }
  } // getGameHistory
